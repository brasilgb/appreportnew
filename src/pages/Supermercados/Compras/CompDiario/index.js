        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <DataTable>
            <DataTable.Header style={{ backgroundColor: '#eee' }}>
              ...
              <DataTable.Title style={styles.colmedia}>Compra dia {sComTotais[0]?.DiaAtual}</DataTable.Title>
              <DataTable.Title style={styles.colmedia}>Compra dia  {sComTotais[0]?.DiaAnterior}</DataTable.Title>
